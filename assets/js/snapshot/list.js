    ...
    ctrl: {
        initEvent: function () {
            ...
            $("[name='Active']").on('switchChange.bootstrapSwitch', function (event, state) {
                ...
                var id = $(this).val();
                JobSnapshotInfoList.ctrl.activeJob(id, state, $(this));
            ...
            $('.btn_delJob').bind('click', function () {
                ...
                layer.msg('你确定删除此任务吗？', {
                    ...
                    , yes: function (index) {
                        layer.close(index);
                        JobSnapshotInfoList.ctrl.deleteJobInfo(id);
                    }
                });
                ...
                success: function (data) {
                    ...
                    if (data.success == true) {
                        ...
                        layer.msg(data.message, function () {
                            window.location.href = "/jobsnapshot/list";
                        });
